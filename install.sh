...
sudo curl -SL https://raw.githubusercontent.com/papertrail/remote_syslog2/master/examples/remote_syslog.init.d -o /etc/init.d/remote_syslog
wait
...
echo "Installation complete; Removing syslog_tmp folder"
cd ../
sudo rm -rf syslog_tmp
